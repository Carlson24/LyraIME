...
fun languages(block: LanguageDefinitionListBuilder.() -> Unit): LanguageDefinitionListBuilder = LanguageDefinitionListBuilder().also(block)
...
class LanguageDefinitionListBuilder {
    ...
    fun build(): List<GrammarDefinition> = allBuilder.map {
