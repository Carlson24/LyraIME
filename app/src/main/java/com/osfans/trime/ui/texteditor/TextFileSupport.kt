...
object TextFileSupport {
    ...
    fun shouldUseDeferredSyntaxHighlight(bytes: Long, displayName: String): Boolean = bytes in 1 until DEFERRED_HIGHLIGHT_THRESHOLD && detectScopeName(displayName) != null
    ...
    fun isProbablyTextFileByExtension(name: String, mimeType: String?): Boolean {
        ...
        return true // give benefit of doubt for unknown types
    }
    ...
    fun detectScopeName(displayName: String): String? = when (extensionOf(displayName)) {
        "lua" -> "source.lua"
