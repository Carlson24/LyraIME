...
class FontFallbackAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): VH {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_text_editor_font_entry, parent, false)
        return VH(view)
    }
    ...
    companion object {
        fun makeTouchHelper(adapter: FontFallbackAdapter, onMoved: () -> Unit): ItemTouchHelper = ItemTouchHelper(object : ItemTouchHelper.SimpleCallback(
